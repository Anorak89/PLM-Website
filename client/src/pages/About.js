        ...
        <div className="container">
          <div className="mission-content">
            ...
            <p className="mission-text">
              Project Lovematch provides basic tennis instruction and activity focused on athletes with 
              intellectual/cognitive disabilities including Down syndrome, autism, neurological impairments, 
              and attention deficit disorder. The program engages local high school students as volunteers 
              to develop one-on-one relationships with the athletes, providing a positive experience for all 
              involved. Our program has been operating for many years, with some of our athletes participating 
              the entire time.
            </p>
          ...
          <div className="contact-content">
            ...
            <div className="donation-info">
              ...
              <p>
                ...
                Athletes participate for a nominal fee, and all donations help us continue serving the community.
              </p>
            </div>
          </div>
        </div>
